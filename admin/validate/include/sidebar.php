<!--//content-inner-->
			...
			<!--/down-->
							<div class="down">	
									  ...
									  <a href="../student_dashboard.php"><span class=" name-caret">Amadikwa Joy</span></a>
									 <p>Administrator </p>
									<ul>
                           ...
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="#"><i class="lnr lnr-book"></i> <span>Navigator</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										  <ul id="menu-academico-sub" >
										    <li id="menu-academico" ><a href="#" ><i class="lnr lnr-book"></i> <span>Login</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										    	<ul id="menu-academico-sub">
										    		<li id="menu-academico-sub"><a href="admin/admin_login.php">admin</a></li>
										    		<li id="menu-academico-avaliacoes"><a href="student_login.php">Student</a></li>
										    	</ul>
