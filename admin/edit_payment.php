...
if(isset($_GET['edit'])){
    ...
    if($session_role == 'admin'){
        ...
        $get_query = "SELECT * FROM payment WHERE id = $edit_id and student = '$session_role'";
        $get_run = mysqli_query($con, $get_query);
    }
...
<?php require_once('include/header.php');?>
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-pencil"></i> Edit Payment <small>Edit Payment Details</small></h1><hr>
                    <ol class="breadcrumb">
                      <li><a href="index.php"><i class="fa fa-tachometer"></i> Dashboard</a></li>
                      <li class="active"><i class="fa fa-pencil"></i> Edit Payment</li>
                    </ol>
                    <?php
                    if(isset($_POST['update'])){
                        ...
                        if(empty($up_title) or empty($up_post_data) or empty($up_tags) or empty($up_image)){
                            ...
                            if(mysqli_query($con, $update_query)){
                                $msg = "Payment Has Been Udated";
                                $path = "img/$up_image";
                                header("location: edit-payment.php?edit=$edit_id");
                                if(!empty($up_image)){
                                ...
                                $error = "Payment Has not Been Updated";
                            }
                        }
                    }
                    ?>
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="submit" class="btn btn-primary" value="Update Payment" name="update">
                            </form>
                        </div>
                    </div>
                </div>
