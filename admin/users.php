...
if(isset($_POST['address'])){
    ...
    foreach($_POST['address'] as $user_id){
        
        $bulk_option = $_POST['address'];
        
        if($bulk_option == 'delete'){
            $bulk_del_query = "DELETE FROM `users` WHERE `users`.`id` = $user_id";
            mysqli_query($con, $bulk_del_query);
        }
        else if($bulk_option == 'student'){
            $bulk_author_query = "UPDATE `users` SET `role` = 'student' WHERE `users`.`id` = $user_id";
