									   ...
									   <div class="error_page error">
												<!--/error-top-->
													<div class="error-top error">
															...
															<span>Whoops! Payment Not Confirmed</span>
															<p>Make online payment or Contact Support for Issues.</p>
															<div class="error-btn">
															<a class="read fourth" href="student_dashboard.php">Return to Home</a>
															</div>
														</div>
